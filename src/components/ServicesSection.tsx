...
const services = [
  {
    ...
    details:
      "Работаем со всеми площадками: поисковые системы, соцсети, форумы, новостные порталы. Удаление или деиндексация контента с юридическими гарантиями.",
  },
  {
    id: "branding",
    slug: "branding",
    ...
    details:
      "Публикации в авторитетных СМИ, создание и продвижение позитивного контента, управление поисковой выдачей (SERM).",
  },
  {
    id: "protection",
    slug: "protection",
    ...
    details:
      "Круглосуточный мониторинг упоминаний, раннее выявление угроз, оперативное реагирование на кризисные ситуации.",
  },
  {
    id: "audit",
    slug: "audit",
    ...
    details:
      "Детальный отчёт с рекомендациями, анализ поисковой выдачи, оценка рисков и стратегия улучшения.",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {services.map((s) => (
            <div
              key={s.id}
              className="bg-card space-y-1 border border-border rounded-xl p-6 hover:border-primary/40 transition-colors group cursor-pointer"
            >
